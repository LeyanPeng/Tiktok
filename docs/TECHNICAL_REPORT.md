...
Ranking*. A system built that way either fails or degrades sharply under a
...
No third-party packages. `requirements.txt` is empty by design. Python 3.10+.
...
| Peak memory | ~1.1 GB (50,000-product in-memory index) |
